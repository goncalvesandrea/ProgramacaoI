...
public class ExemploPrograma {	
	...
	public static void main(String args[]) {
		...
		do {
			...
			case 2:
				...
				if(tipoEntrada.equals("inteiro")) {
					if(data.length == 2) {
						System.out.println(subtracao.calcula(data[0].intValue(), data[1].intValue()));
					}else {
				...
				if(tipoEntrada.equals("double")) {
					if(data.length == 2) {
						System.out.println(subtracao.calcula(data[0], data[1]));
					}else {
				...
				if(tipoEntrada.equals("float")) {
					if(data.length == 2) {
						System.out.println(subtracao.calcula(data[0].floatValue(), data[1].floatValue()));
					}else {
			...
			case 3:
				...
				if(tipoEntrada.equals("inteiro")) {
					if(data.length == 2) {
						System.out.println(multiplicacao.calcula(data[0].intValue(), data[1].intValue()));
					}else {
				...
				if(tipoEntrada.equals("double")) {
					if(data.length == 2) {
						System.out.println(multiplicacao.calcula(data[0], data[1]));
					}else {
				...
				if(tipoEntrada.equals("float")) {
					if(data.length == 2) {
						System.out.println(multiplicacao.calcula(data[0].floatValue(), data[1].floatValue()));
					}else {
			...
			case 4:
				...
				if(tipoEntrada.equals("inteiro")) {
					if(data.length == 2) {
						System.out.println(divisao.calcula(data[0].intValue(), data[1].intValue()));
					}else {
				...
				if(tipoEntrada.equals("double")) {
					if(data.length == 2) {
						System.out.println(divisao.calcula(data[0], data[1]));
					}else {
				...
				if(tipoEntrada.equals("float")) {
					if(data.length == 2) {
						System.out.println(divisao.calcula(data[0].floatValue(), data[1].floatValue()));
					}else {
	...
	public static Integer menu() {
		...
		sb.append("Digite 3 para realizar MULTIPLICACAO \n");
		sb.append("Digite 4 para realizar DIVISAO \n");
